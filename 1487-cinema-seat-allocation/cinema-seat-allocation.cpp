...
public:
    int maxNumberOfFamilies(int n, vector<vector<int>>& reservedSeats) {
        ...
        //Approach 2 - Reduced space complexity - Bit Manipulation

        //Approach - 1
        unordered_map<int , int > mp; // For storing of reserved seats row and seat
        ...
        for(auto& [row , bookedSeatsMask] : mp){ //Key and value
